    ...
    <div className="adopt-container">
      ...
      <div className="adopt-drop">
        ...
        <h6>
          ...
          Temporarily housing animals in shelters keeps them from being loose on
          the streets, where they struggle to find clean food and water, can be
          hit by cars, can be attacked by other animals or cruel humans, or face
        ...
        <h6>
          ...
          every year; 4.2 million are dogs and 1.4 million dogs are euthanized.
          Animals have no voice of their own, no social safety net and very few
          rights under the law. They are vulnerable and, unfortunately,
          mistreated more often than most of us would like to think.
        </h6>
        ...
        <ol>
          ...
          <h6>
            ...
            Donating money is fast, easy and allows facilities to use the money
            where it is needed most. If the nonprofit group you’re donating to
            is recognized by the IRS as a 501(c)(3) organization, you can deduct
            the value of your contribution from any taxes you owe.
          </h6>
          <h6>
            ...
            donations will help provide the care abandoned animals need until a
            suitable home is found for them.
          </h6>
          <h6>
            However, if you can’t donate money, don’t despair – there are other
            ways you can help!
          </h6>
          ...
          <h6>
            ...
            volunteers to provide the needed care required for the animals. Our
            shelter have many of the following:
          </h6>
          <ul>
            <li>
            ...
            <li>
              A humane method of euthanasia, usually an intravenous injection of
              sodium pentobarbital, administered by well-trained, gentle staff
              members
            </li>
            <li>
            ...
            <li>
              An active public education program to teach children and adults to
          ...
          <h6>
            ...
            buying one from a pet store. Your local shelter or rescue operation
            may have the perfect dog for you! Look for breed-specific rescue
            programs if you have your heart set on a certain breed.
          </h6>
          <h6>
            ...
            your family and friends, and hopefully they will consider adopting a
            shelter pet the next time they are ready for a new four-legged
            family member.
          </h6>

          <Link to="/adopt">Click here to adopt a pet</Link>
        </ol>
      </div>
    </div>
  );
