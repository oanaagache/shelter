...
export const DogData = {
  ...
  subtitle2:
    "In a recent study conducted by the National Council on Pet Population Study and Policy (NCPPSP) and published in the July issue of the Journal of Applied Animal Welfare Science (JAAWS), researchers went into 12 selected animal shelters in the United States for one year to find out why. The results of the study show that the top seven reasons for relinquishment for both dogs and cats are the same. “These commonalities suggest that there may be similar ways to address relinquishment in dogs and cats,” says Pam Burney,NCPPSP president. “For people who work in a shelter all day, there isn’t always time to look at these issues. We have impressions of what’s happening, but now we have objective data that will help us develop specific programs to address the issues that have been dentified.",

  img1: pic1,
  subtitle3: "Top 10 Reasons for Relinquishment:",
  subtitle4: "Dogs:",
  li1: "Moving (7%) ",
  li2: "Landlord not allowing pet (6%)",
  li3: "Too many animals in household (4%)",
  li4: "Cost of pet maintenance (5%)",
  li5: "Owner having personal problems (4%)",
  li6: "Inadequate facilities (4%)",
  li7: "No homes available for litter mates (3%)",
  li8: "Having no time for pet (4%)",
  li9: "Pet illness(es) (4%) ",
  li10: "Biting (3%)",

  subtitle5: "Cats:",
  li11: "Moving (8%)",
  li12: "Landlord not allowing pet (6%)",
  li13: "Too many animals in household (11%)",
  li14: "Cost of pet maintenance (6%) ",
  li15: "Owner having personal problems (4%) ",
  li16: "Inadequate facilities (2%)",
  li17: "No homes available for litter mates (6%)",
  li18: "Allergies in family (8%)",
  li19: "House soiling (5%)  ",
  li20: "Incompatibility with other pets (2%)",
  ...
  subtitle27:
    "You have decided that it’s time to add a pet to your family.    After some consideration, you’ve fallen in love with a    particular dog breed. Many people then look for a dog breeder    to make their purebred-pup dream come true. Like any    responsible future pet parent, you still have some questions    before you take the plunge and choose your new",
  subtitle28:
  ...
  li53: "Do you have kids? If so, how old are they and how  dog-savvy are they?",
  li54: "How many hours a day are you out of the house?",
  li55: "Do you have assistance if you are gone for long workdays?",
  li56: "What kind of energy level are you looking for in a dog?",
  li57: "Is how much a dog sheds something that’s important to you?",
  ...
  li58: "Puppies are a lot of fun but are also lots of work. Do you have the time to train a puppy from scratch, including  housebreaking?",
  li59: "Does the energy level of a puppy suit your current  lifestyle?",
  li60: "Do you have the time to socialize your puppy? Pups need  lots of structured exposure to new things in their first  months of life.",
  li61: "Is size important to you? A puppy’s full-grown size is  sometimes hard to estimate.",
  li62: "Are you prepared for any quirky personality traits or  behavior challenges that may arise as your puppy grows up?",
  ...
  subtitle47: "Your perfect match is just a few clicks away!",
  subtitle48:
  ...
  td8: "+ In spite of, have you considered how having a dog    teaches kids about responsibility and compassion?",
  ...
  td14: " + In this case, and on the positive side, consider  enrolling the dog in training school.",

  td15: " My dog has separation anxiety, or his energy is a                          mismatch for us! Plus, he has destruction issues!",
  td16: " + If possible, research online resources on how to  help an energetic dog. To be noted, a bored dog can  also become a destructive dog, when left alone. Make  sure your dog is getting plenty of mental and physical  stimulation. If that doesn’t help, try consulting a  reputable dog trainer.",

  td17: " My dog has health issues that I can’t afford to  manage.",
  td18: "+ On the positive side, talk to your veterinarian  about payment options. Also, for instance, consider  programs like Care Credit.",
  ...
  li64: "Is it wrong to be selective when rehoming a dog?",
  ...
  li65: "I’ve exhausted all my options trying to keep my dog, what  do I do?",
  li66: "Contact breed rescue groups: Discover numerous rescue  groups that, by and large, specifically help your dog’s  breed.",
  li67: "Rehome the dog yourself: Speak with friends and family  and in brief, advertise your intentions.",
  li68: "Post Dog Rehoming Ads: Hang posters on local bulletin  boards and on balance, post on social media.",
  li69: "Make an internet profile: Ultimately, highlight your  dog’s best features and behavioral qualities accordingly  online.",
  li70: " How do I work with my local animal shelter or rescue  group?",

  subtitle54:
    "Generally speaking, surrender your dog to an animal  shelter or a rescue organization.",

  li71: "How do I work with my local animal shelter or rescue  group?",

  subtitle55:
    "Generally speaking, surrender your dog to an animal  shelter or a rescue organization.",

  li72: "What would it take to get your dog to put his best foot                      forward towards a forever home?",
  subtitle56:
    "Generally speaking, surrender your dog to an animal  shelter or a rescue organization.",

  li73: "Are you able to be patient through the process?",
  ...
  subtitle62:
    "Straightaway, pet rehoming takes patience. Although, you may  be in a rush in rehoming your dog. On the whole, finding a  good fit for your dog does take time, love, and patience.",
  li74: "Have you ever had another pet? What happened to it?",
  subtitle63:
  ...
  li75: "Do you have a pet now?",
  li76: "Already having a pet is good. It demonstrates that they  already know what is involved in pet ownership.",

  li77: " If yes, then how long have you had it? In general…  the longer, the better.",
  li78: "If a cat, has your cat been tested for FIV (feline    AIDS) or FILV (feline Leukemia)? If either cat is    positive for one of these diseases placing them    together is disastrous. If a rescued cat is FIV or    FILV positive, place it with another known cat with    the same disease.",

  li79: "If you have another dog/cat, is it altered? Will you be  altering (spaying/neutering) the cat/dog when it reaches  sexual maturity?",
  li80: "The good answer is yes: spay/neuter prevents unwanted  pet births, decreasing the euthanasia happening in  shelters because of too many companion animals and not  enough companion homes. Also, spay/neuter prevents  cancer and decreases the likelihood that a pet will run  away from home or get into fights.",
  li81: "Do you own your home or rent? Do you have a fenced yard?",
  li82: "Ask to see a copy of their lease allowing pets if they  rent. Or ask to use their landlord as a reference.  Fenced yards are best, but aren’t always possible. In  some parts of the country, they aren’t always necessary  (very rural farmland). Make sure the potential adopter  is interested in exercising their new pet. Some dogs  should get up to three or four miles of exercise a day.  “My apartment doesn’t allow pets” is one of the top  three reasons that pets are taken to shelters.",
  li83: "Will you provide references?",
  ...
  li85: "Will the pet be a member of your family or a gift for  someone else?",
  li86: "It is important that everyone who will be living with  the pet meet it first. This minimizes the chances of the  pet being returned to you, winding up at a shelter, or  being abused or neglected.",
  li87: "Some rescue groups always do a home check. This verifies  the individual has given you a real address. You might  consider taking your pet, to see his/her reaction to the  home and the people. If one of the family members never  gets off the couch or turns the TV down to meet you and  your pet, it is probably not going to be the best home.  Some organizations also go back to the home one week  after adoption. This gives them an opportunity to see  that the pet is happy. It also gives the adopter a  chance to return the pet if there is a problem. NEVER DO  A HOME CHECK ALONE! REMEMBER THE BUDDY SYSTEM!",
  li88: "Do you plan on crating the dog? For how long each day?",
  li89: "Think twice before you adopt a young puppy or kitten to  a home where they will be alone for more than four hours  a day. New owners should be willing to adopt on a  weekend or on vacation time to allow the youngster to  adjust to new conditions. Older dogs and cats can  withstand being alone for a normal working day. Eight to  10 hours is possible but should be followed by good  exercise/playtime, which is difficult for people that  have themselves worked a 10 hour day.",
  li90: "If the pet has an accident in the house, what type of  correction do you plan to use?",
  li91: "Think twice before you adopt a young puppy or kitten to  a home where they will be alone for more than four hours  a day. New owners should be willing to adopt on a  weekend or on vacation time to allow the youngster to  adjust to new conditions. Older dogs and cats can  withstand being alone for a normal working day. Eight to  10 hours is possible but should be followed by good  exercise/playtime, which is difficult for people that  have themselves worked a 10 hour day.",
  li92: "How many hours per day will the pet be alone?",
  li93: "Think twice before you adopt a young puppy or kitten to a home where they will be alone for more than four hours  a day. New owners should be willing to adopt on a  weekend or on vacation time to allow the youngster to  adjust to new conditions. Older dogs and cats can  withstand being alone for a normal working day. Eight to  10 hours is possible but should be followed by good  exercise/playtime, which is difficult for people that  have themselves worked a 10 hour day.",
  li94: "Do you have children? How old are they? Have they ever  been around pets?",
  li95: " Children should not be expected to be responsible for  the pet. If that is suggested, think red alert! Very  young kids may be hurt by or may hurt the new pet. This  is a personal issue, based mostly on the type of family  you are talking to. Tread carefully, here. Some  organizations have a strict policy regarding adoptions  to families with children under five. Others judge on a  one-on-one basis. This is where your people skills come  in. Make sure you meet the kids!",
  li96: "Will the pet be going outside at all?",
  ...
  li98: "Will you be declawing the cat?",
  li99: "Declawed cats are more likely to become biters and/or    forget litter box training. Many people are very opposed    to declawing (or see it as a last resort) because of the    gruesome nature of the surgery. At best, it should be    done at the same time as altering.",
  li100:
    "Do you realize that cats can live for more than 20 years?    Do you realize that dogs can live for more than 15 years?",
  li101: "This is a lifetime commitment.",
};
