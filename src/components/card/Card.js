      ...
      {item && (
        <div className="max-w-full flex flex-col flex-wrap m-auto object-contain items-center box-content">
          <div className="rounded overflow-hidden bg-el shadow-lg w-80 cursor-pointer m-5 box-content">
            <img
              className="w-full h-80 object-cover box-content"
            ...
            <div className="p-4 box-content">
              <div className="p-1 box-content">
                <h3 className="align-center">{item.name}</h3>
              </div>
              ...
              <div className="p-1 box-content">
                <h6>Good with:</h6>
                <div className="pl-1 box-content">
                  <h6>
                    Children:
          ...
          {id && (
            <div className="items-end pb-10 box-content">
              <button
                className="text-white bg-pink w-28 py-1 h-10 px-1 box-content"
                onClick={() => {
                  isLoggedIn
